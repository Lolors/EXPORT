...
with st.container():
    ...
    edited_selection = st.data_editor(
        ...
        column_config={
            '선택': st.column_config.CheckboxColumn('선택', help='수정할 주문 한 건만 체크하세요.', width=24),
            '_case_id': None,
            '등록일자': st.column_config.TextColumn('등록일자', width='small'),
            '수출번호': st.column_config.TextColumn('수출번호', width=64),
            '국가': st.column_config.TextColumn('국가', width='small'),
            '바이어': st.column_config.TextColumn('바이어', width=56),
