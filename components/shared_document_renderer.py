...
<div class="section"><span class="section-icon"><svg viewBox="0 0 24 24"><path d="M4 7l8-4 8 4-8 4zM4 7v10l8 4 8-4V7M12 11v10"/></svg></span>PACKING SUMMARY</div><div class="summary"><div class="card"><small>총 CTN 수</small><b>{first_summary}</b></div><div class="card"><small>총 중량</small><b>{fmt_number(total_weight)} kg</b></div><div class="card"><small>운임 계산 참조값</small><div class="freight-ref"><span>CBM</span><b>{fmt_number(round(total_volume_cbm, 2))}</b><span>부피중량</span><b>{fmt_number(int(total_volumetric_weight + 0.5))} kg</b></div></div><div class="card"><small>품목 수</small><b>{item_count} 품목</b></div><div class="card"><small>출고 수량</small><b>{fmt_number(total_qty)}</b></div></div>
