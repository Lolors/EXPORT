...
.summary{{display:grid;grid-template-columns:repeat(5,1fr);gap:6px;margin-bottom:20px}} .card{{border:1px solid #dce3eb;border-radius:7px;padding:6px 7px;background:#f8fafc;text-align:center}} .card small{{font-size:12px;color:#7c8797}} .card b{{font-size:18px;color:#214f76;white-space:nowrap}} .freight-ref{{margin:5px auto 0;display:grid;grid-template-columns:auto auto;justify-content:center;gap:3px 8px;align-items:baseline;text-align:center}} .freight-ref span{{font-size:12px;color:#607083;text-align:center}} .freight-ref b{{font-size:15px;text-align:center}}
...
<div class="section"><span class="section-icon"><svg viewBox="0 0 24 24"><path d="M4 7l8-4 8 4-8 4zM4 7v10l8 4 8-4V7M12 11v10"/></svg></span>PACKING SUMMARY</div><div class="summary"><div class="card"><small>총 CTN 수</small><br><b>{first_summary}</b></div><div class="card"><small>총 중량</small><br><b>{fmt_number(total_weight)} kg</b></div><div class="card"><small>운임 계산 참조값</small><div class="freight-ref"><span>CBM</span><b>{fmt_number(total_volume_cbm)}</b><span>부피중량</span><b>{fmt_number(total_volumetric_weight)} kg</b></div></div><div class="card"><small>품목 수</small><br><b>{item_count} 품목</b></div><div class="card"><small>출고 수량</small><br><b>{fmt_number(total_qty)}</b></div></div>
