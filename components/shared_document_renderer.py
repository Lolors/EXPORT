...
.summary{{display:grid;grid-template-columns:repeat(5,1fr);gap:6px;margin-bottom:20px}} .card{{border:1px solid #dce3eb;border-radius:7px;padding:6px 7px;background:#f8fafc}} .card small{{font-size:9px;color:#7c8797}} .card b{{font-size:15px;color:#214f76;white-space:nowrap}} .freight-ref{{margin-top:3px;display:grid;grid-template-columns:auto 1fr;gap:2px 5px;align-items:baseline}} .freight-ref span{{font-size:9px;color:#607083}} .freight-ref b{{font-size:12px;text-align:right}}
